...
void display_sub_basic()
{
	...
	g_print("i. Get Mute\n");
	g_print("[ exclude audio ]\t");
	g_print("ex. exclude audio \t");
	g_print("iex. is audio excluded \n");
	...
	g_print("x. Set DST ROI\t");
	g_print("y. Get DST ROI\t");
	g_print("M. Set ROI mode\t");
	g_print("N. Get ROI mode\n");
	g_print("[x display] zl. set zoom level\t");
	g_print("zp. Set zoom start\t");
	g_print("[Track] tl. Get Track language info\n");
	g_print("[subtitle] A. Set(or change) subtitle path\n");
	g_print("[subtitle] ss. Switch Internal Subtitle (ref. tl)\n");
	g_print("[Video Capture] C. Capture \n");
	g_print("[Audio Frame Decode] D. Decoding Audio Frame  E. Decoding Video Frame \n");
	g_print("[Buffering Value] bt. Set Pre Buffering Time ba. Use Adaptive Buffer bf. Use Fixed Buffer\n");
	g_print("[Private Buffering Value] bp. Use Private Buffering mode\n");
