 ...
 * @remarks If the current display type is not #PLAYER_DISPLAY_TYPE_X11, no operation is performed.
 * @param[in]   user_data  The user data passed from the callback registration function
 * @param[in]	video_width The width of the video
 * @param[in]	video_height The height of the video
 ...
 */
typedef unsigned int (*player_x11_pixmap_updated_cb)(void *user_data, unsigned int video_width, unsigned int video_height);
